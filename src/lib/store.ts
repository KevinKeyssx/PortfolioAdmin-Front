...
// ──────────────────────────────────────────────────────────────
// Datos iniciales — Lista de Valores
// ──────────────────────────────────────────────────────────────
...
export function getListaValores(): ListaValores[] {
    return get( listaValoresStore );
}


export function getLovValores(): LovValor[] {
    return get( lovValoresStore );
}


export function getLovValoresByListaId( listaId: number ): LovValor[] {
    return get( lovValoresStore ).filter( lov => lov.lov_id === listaId );
}


export function getListaById( id: number ): ListaValores | undefined {
    return get( listaValoresStore ).find( lista => lista.id === id );
}


// ──────────────────────────────────────────────────────────────
// CRUD — Lista de Valores
// ──────────────────────────────────────────────────────────────

export function addListaValor( lista: Omit<ListaValores, 'id' | 'created_at'> ): ListaValores {
...
export function updateListaValor( id: number, updates: Partial<ListaValores> ): void {
...
export function deleteListaValor( id: number ): void {
...
export function addLovValor( lov: Omit<LovValor, 'id' | 'created_at'> ): LovValor {
...
export function updateLovValor( id: string, updates: Partial<LovValor> ): void {
...
export function deleteLovValor( id: string ): void {
